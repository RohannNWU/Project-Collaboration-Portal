...
from .models import User, Project, UserProject, ProjectChat, ChatMessage, Task, User_Task, Document
from django.core.files.storage import default_storage
from django.core.files.base import ContentFile
from django.http import HttpResponse
from rest_framework.permissions import IsAuthenticated
from .serializers import (
    UserSerializer, ProjectSerializer, TaskSerializer, MessageSerializer, ChatMessageSerializer, ProjectChatSerializer,
