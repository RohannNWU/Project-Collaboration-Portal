...
from pcp_webapp.views import (
    ...
    UpdateTaskView, DocumentUploadView, GetProjectTasksView,
    GetTaskDocumentsView, GetProjectDataView
)
...
urlpatterns = [
    ...
    path('api/getprojectdata/', GetProjectDataView.as_view(), name='get_project_data'),
]
